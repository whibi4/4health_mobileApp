...
export default class SettingEditBloodType extends React.Component {
    ...
    render() {
        return (
            <Block>
                ...
                titleStyle={{ fontFamily: 'Montserrat-Bold' }} title="BLOOD TYPE" />
                <Block style={{ paddingTop: 20, }} width={Dimensions.get('screen').width} middle={true} center={true} >
                    ...
                    <Icon name="droplet" family="Feather" color="#c0392b" size={40} />
                    <Input style={{marginTop: 20, borderColor: "#7652af", borderWidth: 2 ,width:Dimensions.get('screen').width * 0.9 }} color="#7652af" placeholder="Blood Type" />
