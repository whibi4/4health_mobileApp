...
export default class SettingEditWeight extends React.Component {
    state = {
        val : 50
    }
        ...
        return (
            <Block>
                ...
                <Block style={{ paddingTop: 20, }} width={Dimensions.get('screen').width} middle={true} center={true} >
                    ...
                    <Icon name="dashboard" family="AntDesign" color="#2c3e50" size={40} />
                    <Text style={{color: '#2c3e50', fontFamily: 'Montserrat-Bold'}}>{this.state.val+' KG'}</Text>
